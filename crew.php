            ...
            <div class="table-responsive">
                <table id="example" class="table table--default">
                    ...
                    <?php
													...
													$no = 1;
													$query = mysqli_query($db, 'SELECT * FROM crew');
													while ($data = mysqli_fetch_array($query)) {
													?>
                        <tr>
                            <td><img class="mr-15 wh-34 radius-xs img-fluid order-bg-opacity-primary" src="assets/media/avatars/<?php echo $data['nim'] ?>.jpg" onerror="this.onerror=null;this.src='img/blank.png';"><?php echo $data['fullname'] ?></td>
                            ...
                            <td>+62<?php echo $data['phonenumber'] ?></td>


                            <td>
                                                <ul class="orderDatatable_actions mb-0 d-flex flex-wrap">
                                                    <li>
                                                        <a href="update_crew.php?id=<?php echo $data['id'] ?>" class="edit">
                                                            <span data-feather="edit"></span></a>
                                                    </li>
                                                    <li>
                                                        <a href="aksi/delete_crew.php?id=<?php echo $data['id'] ?>" class="remove">
