...
<div class="row">
                    ...
                    <div class="breadcrumb-main">
                                <h4 class="text-capitalize breadcrumb-title">Content Workheet</h4>
                                <div class="breadcrumb-action justify-content-center flex-wrap">
                                    <div class="action-btn">
                                    </div>
                                    <div class="action-btn">
                                        <a href="add_content.php" class="btn btn-sm btn-primary btn-add">
            ...
            <div class="table-responsive">
                <table id="example" class="table table--default">
                    ...
                    <?php
													...
													$no = 1;
													$query = mysqli_query($db, 'SELECT * FROM worksheet');
													while ($data = mysqli_fetch_array($query)) {
													?>
                        <tr>
                            <td><img class="mr-15 wh-34 radius-xs img-fluid order-bg-opacity-primary" src="img/<?php echo $data['owner'] ?>.jpg" alt="img"> <?php echo $data['owner'] ?></td>
                            <td><?php echo $data['projectname'] ?></td>
                            <td><?php echo $data['channel'] ?></td>
                            <td><?php echo $data['contenttype'] ?></td>
                            <td>                                                    <span class="bg-opacity-success  color-success rounded-pill userDatatable-content-status active"><?php echo $data['status'] ?></span></td>
                            <td><?php echo $data['notes'] ?></td>
                            <td><?php echo $data['datetimeup'] ?></td>
                            <td>
                                                <ul class="orderDatatable_actions mb-0 d-flex flex-wrap">
                                                    <li>
                                                        <a href="update_content.php?id=<?php echo $data['id'] ?>" class="edit">
                                                            <span data-feather="edit"></span></a>
                                                    </li>
                                                    <li>
                                                        <a href="aksi/delete_content.php?id=<?php echo $data['id'] ?>" class="remove">
