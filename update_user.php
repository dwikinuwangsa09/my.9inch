                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="global-shadow border px-sm-30 py-sm-50 px-0 py-20 bg-white radius-xl w-100 mb-40">
                            <div class="row justify-content-center">
                                        ...
                                        <div class="card add-product p-sm-30 p-20 mb-30">
                                            <div class="card-body p-0">
                                                <div class="card-header">
                                                    <h6 class="fw-500">Update User</h6>
                                                </div>
                                                <!-- Start: card body -->
								...
								$id         = $_GET['id'];
								$konten  = mysqli_query($db, "select * from users where id='$id'");
								...
								?>
                                                    ...
                                                    <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="id" placeholder="Nakula Sadewa" value="<?php echo $row['id'];?>" readonly required>
                                                        </div>                                             
                                                        <div class="form-group">
                                                            <label for="name1">Full Name</label>
                                                            <input type="text" class="form-control" name="fullname" placeholder="Nakula Sadewa" value="<?php echo $row['full_name'];?>" readonly required>
                                                        </div>
...
<!-- form group 2 -->
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="email" class="form-control" name="email" placeholder="nakula@9inch.studio" value="<?php echo $row['email'];?>" readonly required>
                                                        </div>                                                        
<!-- form group 2 -->
        ...
        <select class="js-example-basic-single js-states form-control" name="role" required>
            ...
            ?>
                                        ...
                                        <div class="button-group add-product-btn d-flex justify-content-end mt-40">
                                            ...
                                            <button class="btn btn-primary btn-default btn-squared text-capitalize">Update User
                                            </button>
