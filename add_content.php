                                        ...
                                        <div class="card add-product p-sm-30 p-20 mb-30">
                                            <div class="card-body p-0">
                                                ...
                                                <div class="add-product__body px-sm-40 px-20">
                                                    <!-- Start: form -->
                                                    <form action="aksi/simpan_content.php" method="post">
                                                        <!-- form group -->
                                                        <div class="form-group">
                                                            <label for="name1">Project Name</label>
                                                            <input type="text" class="form-control" name="projectname" placeholder="Little Reminder" required>
                                                        </div>
                                                        ...
                                                        <div class="atbd-date-picker">
                                                            <div class="form-group mb-0 form-group-calender">
                                                                <div class="position-relative">
                                                                    <input type="text" class="form-control form-control-default" name="datetimeup" placeholder="January 20, 2018" required>
...
<!-- form group 2 -->
            ...
            ?>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="rawmaterial" placeholder="https://drive.google.com/drive/folders/xxxxxxxxxx" required>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="firstpic" placeholder="https://drive.google.com/drive/folders/xxxxxxxxxx" required>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            <div>
                                                                ...
                                                                <select class="js-example-basic-single js-states form-control" name="status">
                                                                    <option value="9TV">Content In Progress</option>
                                                                    <option value="9TV">Thumbnail In Progress</option>
                                                                    <option value="9TV">Feedback Needed</option>
                                                                    <option value="9TV">Approved</option>
                                                                    <option value="9TV">Scheduled</option>
                                                                    <option value="9TV">Posted</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="email" class="form-control"  name="responsible" required>
                                                        </div>                                   
                                                        
                                                        <!-- form group 1 -->
                                                        <div class="form-group">
                                                            <label for="name2">Link To Content (Drive)</label>
                                                            <input type="text" class="form-control" name="linktodrive" placeholder="https://drive.google.com/drive/folders/xxxxxxxxxx" required>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="caption" placeholder="https://drive.google.com/drive/folders/xxxxxxxxxx" required>
                                                        </div>
                                        ...
                                        <div class="button-group add-product-btn d-flex justify-content-end mt-40">
                                            ...
                                            <button class="btn btn-primary btn-default btn-squared text-capitalize">Add Content
                                            </button>
