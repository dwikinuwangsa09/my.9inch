                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="global-shadow border px-sm-30 py-sm-50 px-0 py-20 bg-white radius-xl w-100 mb-40">
                            <div class="row justify-content-center">
								...
								$id         = $_GET['id'];
								$konten  = mysqli_query($db, "select * from crew where id='$id'");
								$row        = mysqli_fetch_array($konten);
                                $databaseDivision = $row['division'];
                                $databaseRole = $row['role'];


								?>
                                                    <form action="aksi/update_crew.php" method="post">
                                                        <!-- form group -->
                                                        <div class="form-group">
                                                            <label for="name1">Smart Card UID</label>
                                                            <input type="text" class="form-control" name="uid" placeholder="Tap SmartCard..." value="<?php echo $row['uid'];?>" readonly required>
                                                        </div>

                                                        <div class="form-group">
                                                            <label for="name1">NIM</label>
                                                            <input type="text" class="form-control" name="nim" placeholder="418xxxxx" value="<?php echo $row['nim'];?>" readonly required>
                                                        </div>
                                                        
                                                        <div class="form-group">
                                                            <label for="name1">Full Name</label>
                                                            <input type="text" class="form-control" name="fullname" placeholder="Nakula Sadewa" value="<?php echo $row['fullname'];?>" readonly required>
                                                        </div>

                                                        <div class="form-group">
                                                            <label for="name1">Batch</label>
                                                            <input type="text" class="form-control" name="batch" placeholder="2022" value="<?php echo $row['batch'];?>" required>
                                                        </div>
                                                        ...
                                                        <div class="atbd-date-picker">
                                                            <div class="form-group mb-0 form-group-calender">
                                                                <div class="position-relative">
                                                                    <input type="text" class="form-control form-control-default" name="dob" placeholder="" value="<?php echo $row['dob'];?>" required>
...
<!-- form group 2 -->
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="email" class="form-control" name="email" placeholder="nakula@9inch.studio" value="<?php echo $row['email'];?>" required>
                                                        </div>                                                        
<!-- form group 2 -->
<div class="form-group">
    <div>
        ...
        <select class="js-example-basic-single js-states form-control" name="division" required>
            ...
            foreach ($channels as $channel) {
                $selected = ($databaseDivision == $channel) ? 'selected' : '';
...
<div class="form-group">
    <div>
        ...
        <select class="js-example-basic-single js-states form-control" name="role" required>
            ...
            foreach ($channels as $channel) {
                $selected = ($databaseRole == $channel) ? 'selected' : '';
                echo "<option value='$channel' $selected>$channel</option>";
            }
            ?>
        </select>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" class="form-control" name="phonenumber" value="<?php echo $row['phonenumber'];?>" placeholder="83825xxxxx" required>
                                                        </div>    
                                        ...
                                        <div class="button-group add-product-btn d-flex justify-content-end mt-40">
                                            ...
                                            <button class="btn btn-primary btn-default btn-squared text-capitalize">Update Crew
                                            </button>
